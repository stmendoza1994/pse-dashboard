...
if page == "Dashboard":
    ...
    table_html = f"""
    <div style='overflow-x:auto;overflow-y:auto;max-height:420px;max-width:75%;margin:0 auto;margin-left:auto;margin-right:auto;border-radius:14px;border:1px solid #b8d4e4;
